...
export class ChatMessageResponseDto {
    ...
    constructor(chatMessage: ChatMessage) {
        ...
        this.reply = chatMessage.reply ? new ChatMessageResponseDto(chatMessage.reply) : null;
    }
}
...
export class PaginatedChatMessageResponseDto extends PaginatedResponse(
    ...
    constructor(
        ...
        const chatMessageDtos = chatMessages.map((chatMessage) => new ChatMessageResponseDto(chatMessage));
