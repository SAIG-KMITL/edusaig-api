import { Body, Controller, Delete, Get, HttpCode, HttpStatus, Injectable, Param, ParseUUIDPipe, Patch, Post, Query, Req } from "@nestjs/common";
...
export class ChatMessageController {
    ...
    async findAll(
        ...
        return await this.chatMessageService.findAll({ userId: request.user.id, ...query });
    }
    ...
    async create(
        ...
        return await this.chatMessageService.create(request.user.id, createChatMessageDto);
    }
