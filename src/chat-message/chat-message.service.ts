...
import { UpdateChatMessageDto, CreateChatMessageDto, PaginatedChatMessageResponseDto } from './dtos';
...
export class ChatMessageService {
    ...
    async update(criteria: FindOptionsWhere<ChatMessage>, updateChatMessageDto: UpdateChatMessageDto): Promise<ChatMessage> {
        try {
