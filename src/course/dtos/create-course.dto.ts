...
export class CreateCourseDto {
  ...
  @IsNotEmpty()
  @IsEnum(CourseLevel, {
    message: `Invalid level. Level should be either ${CourseLevel.BEGINNER}, ${CourseLevel.INTERMEDIATE}, or ${CourseLevel.ADVANCED}`,
  })
  @ApiProperty({
  ...
  @IsNotEmpty()
  @IsEnum(CourseStatus, {
    message: `Invalid status. Status should be either ${CourseStatus.DRAFT}, ${CourseStatus.PUBLISHED}, or ${CourseStatus.ARCHIVED}`,
  })
  @IsNotEmpty()
  @ApiProperty({
