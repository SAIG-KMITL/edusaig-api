...
export class ChatRoomController { 
    ...
    async findById(
        ...
        return new ChatRoomResponseDto(await this.chatRoomService.findOne({ where: { id } }));
    }
    ...
    async create(
        ...
        return new ChatRoomResponseDto(await this.chatRoomService.create(createChatRoomDto));
    }
    ...
    async update(
        ...
        return new ChatRoomResponseDto(await this.chatRoomService.update({ id }, updateChatRoomDto));
    }
